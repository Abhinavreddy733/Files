...
"[project]/.next-internal/server/app/api/file/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/file/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    try {
        ...
        const projectFiles = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ProjectFile"].find({
            project: projectId
        }).lean();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(projectFiles, {
            status: 200
        });
    } catch (e) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(request, { params }) {
    ...
    try {
        ...
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ProjectFile"].deleteOne({
            _id: fileId
        });
        const resFileContent = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ProjectFileContent"].deleteOne({
            projectFile: fileId
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c018c0e7._.js.map